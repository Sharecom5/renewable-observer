  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="mb-12 border-b border-border pb-8">
        <h1 className="text-2xl md:text-3xl font-bold tracking-tighter mb-4 text-foreground">{category.name}</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        {posts.length > 0 ? (
          ...
          <p className="col-span-full py-12 text-muted-foreground">
